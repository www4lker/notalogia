---
{"dg-publish":true,"permalink":"/0-vault/1-notas-literais/anelo/style-guide-python/","tags":["ANELO"],"dgHomeLink":true,"dgShowLocalGraph":true,"dgShowFileTree":true,"dgEnableSearch":true}
---
...
## relacionados:
- notas:
1. [[0 - VAULT/1 NOTAS LITERAIS/ANELO/PYTHON 5 - 3\|PYTHON 5 - 3]]
2. [[0 - VAULT/1 NOTAS LITERAIS/ANELO/LATAM 2023 - 2.5 Section 5 – Comments\|LATAM 2023 - 2.5 Section 5 – Comments]]
- tags: #ANELO 
- Fontes & Links: 
---

1. **Introdução**
   - Descrição das convenções de codificação para o código Python na biblioteca padrão.
   - Destaque para a importância da legibilidade do código e da consistência.
   - Evolução do guia de estilo ao longo do tempo.

2. **Consistência e Flexibilidade**
   - Importância da consistência com o guia de estilo.
   - Flexibilidade para ser inconsistente quando necessário.
   - Razões válidas para ignorar diretrizes específicas.

3. **Layout de Código**
   - Indentação: uso de 4 espaços por nível de indentação.
   - Continuação de linhas e alinhamento.
   - Uso de parênteses para quebras de linha.
   - Tabulações versus espaços.
   - Limite máximo de comprimento de linha.
   - Quebra de linha antes ou depois de um operador binário.
   - Uso de linhas em branco para separar definições de funções e classes.

4. **Codificação de Strings**
   - Recomendação para uso consistente de aspas simples ou duplas.
   - Uso de aspas duplas para strings de várias linhas.
   
5. **Espaços em Expressões e Declarações**
   - Recomendações para evitar espaços desnecessários em várias situações.
   - Uso correto de espaços em torno de operadores e sinais de igual.

6. **Comentários**
   - Importância de manter os comentários atualizados.
   - Uso de comentários em bloco e comentários em linha.
   - Convenções para escrever boas docstrings.

7. **Convenções de Nomenclatura**
   - Estilos de nomenclatura recomendados.
   - Uso de prefixos e sufixos especiais para diferentes tipos de nomes.
   - Diferenciação entre nomes públicos e internos.

8. **Recomendações de Programação**
   - Dicas para escrever código Python que seja eficiente e compatível com outras implementações.
   - Boas práticas para comparações, exceções, gerenciamento de recursos, entre outros.
   - Uso de anotações de função e variável de acordo com o PEP 484 e PEP 526.
